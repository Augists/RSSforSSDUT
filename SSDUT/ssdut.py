...
class ssdut():
    def __init__(self):
        ...
        initialize:
            ...
            headers
        '''
        self.link = "http://ssdut.dlut.edu.cn/index.htm"
    ...
    def response200(self, response):
        ...
        stu_list = soup.find(class_='a_global_dg a_alt_4')
        under_list = stu_list.find(class_='xi_index_tab')
        if self.update_or_not(under_list):
            ...
            for index, li in enumerate(under_li[0:7]):
                ...
                detailed_url = "http://ssdut.dlut.edu.cn/" + found_url[0]
